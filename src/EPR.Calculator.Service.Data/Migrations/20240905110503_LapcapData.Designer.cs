...
namespace EPR.Calculator.Service.Function.Data.Migrations
{
    ...
    [Migration("20240905110503_LapcapData")]
    partial class LapcapData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EPR.Calculator.Service.Function.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 5, 12, 5, 3, 773, DateTimeKind.Local).AddTicks(2558),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 5, 12, 5, 3, 773, DateTimeKind.Local).AddTicks(2561),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 5, 12, 5, 3, 773, DateTimeKind.Local).AddTicks(2563),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 5, 12, 5, 3, 773, DateTimeKind.Local).AddTicks(2565),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 5, 12, 5, 3, 773, DateTimeKind.Local).AddTicks(2567),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
