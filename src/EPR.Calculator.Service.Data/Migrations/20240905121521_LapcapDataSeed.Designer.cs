...
namespace EPR.Calculator.Service.Function.Data.Migrations
{
    ...
    [Migration("20240905121521_LapcapDataSeed")]
    partial class LapcapDataSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EPR.Calculator.Service.Function.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 5, 13, 15, 21, 595, DateTimeKind.Local).AddTicks(3009),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 5, 13, 15, 21, 595, DateTimeKind.Local).AddTicks(3012),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 5, 13, 15, 21, 595, DateTimeKind.Local).AddTicks(3014),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 5, 13, 15, 21, 595, DateTimeKind.Local).AddTicks(3017),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 5, 13, 15, 21, 595, DateTimeKind.Local).AddTicks(3019),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
            ...
            modelBuilder.Entity("EPR.Calculator.Service.Function.Data.DataModels.LapcapDataDetail", b =>
                {
                    ...
                    b.HasOne("EPR.Calculator.Service.Function.Data.DataModels.LapcapDataTemplateMaster", "LapcapDataTemplateMaster")
                        .WithOne("LapcapDataDetail")
                        .HasForeignKey("EPR.Calculator.Service.Function.Data.DataModels.LapcapDataDetail", "UniqueReference")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
