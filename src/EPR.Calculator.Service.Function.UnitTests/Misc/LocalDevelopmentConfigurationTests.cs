namespace EPR.Calculator.Service.Function.UnitTests.Misc
{
    ...
    public class LocalDevelopmentConfigurationTests
    {
        ...
        public void BillingFileJsonBlobContainerName()
        {
            ...
            this.Configuration
                .Setup(c => c.GetSection(nameof(LocalDevelopmentConfiguration.BillingFileJsonBlobContainerName)))
                .Returns(resultFileNameSection.Object);

            // Assert
            Assert.IsInstanceOfType(this.TestClass.BillingFileJsonBlobContainerName, typeof(string));
        }
        ...
        public void BlobConnectionString()
        {
            ...
            this.Configuration
                .Setup(c => c.GetSection(nameof(LocalDevelopmentConfiguration.BlobConnectionString)))
                .Returns(resultFileNameSection.Object);
        ...
        public void InstrumentationKey()
        {
            ...
            this.Configuration
                .Setup(c => c.GetSection(nameof(LocalDevelopmentConfiguration.InstrumentationKey)))
                .Returns(resultFileNameSection.Object);
