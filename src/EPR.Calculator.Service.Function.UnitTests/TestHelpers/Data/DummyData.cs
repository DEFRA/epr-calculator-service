...
public static partial class DummyData
{
    ...
    public static void SeedDatabaseForInitialRun(ApplicationDBContext context)
    {
        ...
        {
            new() { Id = 1, RelativeYear = new RelativeYear(2025), Classification = RunClassification.InitialRunCompleted, Name = "CalculatorRunTest1" },
            new() { Id = 2, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, Name = "CalculatorRunTest2" }
        };
        ...
        {
            new() { Id = 5, Name = "Plastic", Code = MaterialCodes.Plastic },
            new() { Id = 6, Name = "Steel", Code = MaterialCodes.Steel },
    ...
    public static void SeedDatabaseForUnclassified(ApplicationDBContext context)
    {
        ...
        var runs = new List<CalculatorRun>
        {
            new() { Id = 1, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, Name = "CalculatorRunTest1" },
            new() { Id = 2, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, Name = "CalculatorRunTest2" }
        };
        context.CalculatorRuns.AddRange(runs);
        ...
        var producerReportedMaterials = new List<ProducerReportedMaterial>
        {
            ...
            new() { ProducerDetailId = 2, MaterialId = 1, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.Household, PackagingTonnage = 50 },
            new() { ProducerDetailId = 2, MaterialId = 1, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.Household, PackagingTonnage = 50 },
            new() { ProducerDetailId = 2, MaterialId = 2, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.PublicBin, PackagingTonnage = 100 },
            new() { ProducerDetailId = 2, MaterialId = 2, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.PublicBin, PackagingTonnage = 100 },
            new() { ProducerDetailId = 2, MaterialId = 3, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.HouseholdDrinksContainers, PackagingTonnage = 150 },
            new() { ProducerDetailId = 2, MaterialId = 3, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.HouseholdDrinksContainers, PackagingTonnage = 150 }
        };
        context.ProducerReportedMaterial.AddRange(producerReportedMaterials);
