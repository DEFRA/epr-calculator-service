    ...
    public static class TestData
    {
        ...
        public static CalcResultSummary GetCalcResultSummary()
        {
            return new CalcResultSummary
            {
                ...
                ProducerDisposalFees = GetProducerDisposalFeesWithLevel1(),
            };
        }

        public static List<CalcResultSummaryProducerDisposalFees> GetProducerDisposalFeesWithLevel1()
        {
        ...
        public static List<CalcResultSummaryProducerDisposalFees> GetProducerDisposalFeesWithoutLevel1()
        {
            var fees = GetProducerDisposalFeesWithLevel1();
        ...
        public static ImmutableArray<MaterialDto> Materials =>
        [
            new()
            {
                Id = 1,
        ...
        public static List<DefaultParameterTemplateMaster> GetDefaultParameterTemplateMasterData()
        {
            return
            [
        ...
        public static List<CalculatorRunOrganisationDataMaster> GetCalculatorRunOrganisationDataMaster()
        {
            return
            [
        ...
        {
            List<CalculatorRunOrganisationDataMaster> orgMasters =
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2024), EffectiveFrom = DateTime.UtcNow, EffectiveTo = DateTime.UtcNow, CreatedAt = DateTime.UtcNow, CreatedBy = "Test user" },
                new() { Id = 2, RelativeYear = new RelativeYear(2024), EffectiveFrom = DateTime.UtcNow, EffectiveTo = DateTime.UtcNow, CreatedAt = DateTime.UtcNow, CreatedBy = "Test user" }
            ];
            context.CalculatorRunOrganisationDataMaster.AddRange(orgMasters);
            context.SaveChanges();

            List<CalculatorRun> runs =
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 7, CalculatorRunOrganisationDataMasterId = orgMasters[0].Id, Name = "CalculatorRunTest1" },
                new() { Id = 2, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 2, CalculatorRunOrganisationDataMasterId = orgMasters[1].Id, Name = "CalculatorRunTest2" }
            ];
            ...
            [
                new() { Id = 1, CalculatorRunId = 1, ProducerName = "Test1", ProducerId = 1, TradingName = "TN1" },
                new() { Id = 2, CalculatorRunId = 1, ProducerName = "Test2", ProducerId = 2, TradingName = "TN2" },
                new() { Id = 3, CalculatorRunId = 2, ProducerName = "Test1", ProducerId = 1, TradingName = "TN3" },
                new() { Id = 4, CalculatorRunId = 1, ProducerName = "Test3", ProducerId = 3, TradingName = "TN4" }
            ];
            context.ProducerDetail.AddRange(producerDetails);
            context.SaveChanges();

            var orgDataDetails = MapToOrgDataDetails(runs, producerDetails);
            context.CalculatorRunOrganisationDataDetails.AddRange(orgDataDetails);
            context.SaveChanges();
            ...
            [
                new() { ProducerDetailId = 1, MaterialId = 1, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.Household, PackagingTonnage = 50, PackagingTonnageRed = 50 },
                new() { ProducerDetailId = 1, MaterialId = 1, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.Household, PackagingTonnage = 50, PackagingTonnageAmber = 50 },
                new() { ProducerDetailId = 1, MaterialId = 2, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.PublicBin, PackagingTonnage = 100, PackagingTonnageGreen = 100 },
                new() { ProducerDetailId = 1, MaterialId = 2, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.PublicBin, PackagingTonnage = 100, PackagingTonnageRedMedical = 100 },
                new() { ProducerDetailId = 1, MaterialId = 3, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.HouseholdDrinksContainers, PackagingTonnage = 150, PackagingTonnageAmberMedical = 150 },
                new() { ProducerDetailId = 1, MaterialId = 3, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.HouseholdDrinksContainers, PackagingTonnage = 150, PackagingTonnageGreenMedical = 150 },

                new() { ProducerDetailId = 2, MaterialId = 1, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.Household, PackagingTonnage = 50, PackagingTonnageRed = 50 },
                new() { ProducerDetailId = 2, MaterialId = 1, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.Household, PackagingTonnage = 50, PackagingTonnageAmber = 50 },
                new() { ProducerDetailId = 2, MaterialId = 2, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.PublicBin, PackagingTonnage = 100, PackagingTonnageGreen = 100 },
                new() { ProducerDetailId = 2, MaterialId = 2, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.PublicBin, PackagingTonnage = 100, PackagingTonnageRedMedical = 100 },
                new() { ProducerDetailId = 2, MaterialId = 3, SubmissionPeriod = "2025-H1", PackagingType = PackagingTypes.HouseholdDrinksContainers, PackagingTonnage = 150, PackagingTonnageAmberMedical = 150 },
                new() { ProducerDetailId = 2, MaterialId = 3, SubmissionPeriod = "2025-H2", PackagingType = PackagingTypes.HouseholdDrinksContainers, PackagingTonnage = 150, PackagingTonnageGreenMedical = 150 },
            ];
        ...
        public static void SeedDatabaseForUnclassified(ApplicationDBContext context)
        {
            ...
            List<CalculatorRun> runs =
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 2, CalculatorRunOrganisationDataMasterId = orgMasters[0].Id, Name = "CalculatorRunTest1" },
                new() { Id = 2, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 2, CalculatorRunOrganisationDataMasterId = orgMasters[1].Id, Name = "CalculatorRunTest2" }
            ];
            context.CalculatorRuns.AddRange(runs);
        ...
        public static void SeedDatabaseForInitialRunCompleted(ApplicationDBContext context)
        {
            List<CalculatorRunOrganisationDataMaster> orgMasters =
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2024), EffectiveFrom = DateTime.UtcNow, EffectiveTo = DateTime.UtcNow, CreatedAt = DateTime.UtcNow, CreatedBy = "Test user" },
                new() { Id = 2, RelativeYear = new RelativeYear(2024), EffectiveFrom = DateTime.UtcNow, EffectiveTo = DateTime.UtcNow, CreatedAt = DateTime.UtcNow, CreatedBy = "Test user" },
                new() { Id = 3, RelativeYear = new RelativeYear(2024), EffectiveFrom = DateTime.UtcNow, EffectiveTo = DateTime.UtcNow, CreatedAt = DateTime.UtcNow, CreatedBy = "Test user" }
            ];
            context.CalculatorRunOrganisationDataMaster.AddRange(orgMasters);
            ...
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 7, CalculatorRunOrganisationDataMasterId = orgMasters[0].Id, Name = "CalculatorRunTest1" },
                new() { Id = 2, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 12, CalculatorRunOrganisationDataMasterId = orgMasters[1].Id, Name = "CalculatorRunTest2" },
                new() { Id = 3, RelativeYear = new RelativeYear(2025), CalculatorRunClassificationId = 2, CalculatorRunOrganisationDataMasterId = orgMasters[2].Id, Name = "CalculatorRunTest3" }
            ];
            context.CalculatorRuns.AddRange(runs);
            ...
            [
                ...
                new() { Id = 2, CalculatorRunId = 1, ProducerName = "Test2", ProducerId = 2, TradingName = "TN2" },
                new() { Id = 4, CalculatorRunId = 1, ProducerName = "Test3", ProducerId = 3, TradingName = "TN4" },
                new() { Id = 5, CalculatorRunId = 1, ProducerName = "Test4", ProducerId = 4, TradingName = "TN5" },
                new() { Id = 6, CalculatorRunId = 2, ProducerName = "Test2", ProducerId = 2, TradingName = "TN2" },
                new() { Id = 3, CalculatorRunId = 2, ProducerName = "Test1", ProducerId = 1, TradingName = "TN3" },
                new() { Id = 7, CalculatorRunId = 3, ProducerName = "Test1", ProducerId = 1, TradingName = "TN3" }
            ];
            context.ProducerDetail.AddRange(producerDetails);
        ...
        private static List<CalculatorRunOrganisationDataDetail> MapToOrgDataDetails(List<CalculatorRun> runs, List<ProducerDetail> producerDetails)
        {
            var orgDataDetails = new List<CalculatorRunOrganisationDataDetail>();

            foreach (var group in producerDetails.GroupBy(p => p.CalculatorRunId))
            {
                foreach (var producerDetail in group)
                {
                    var masterId = runs.First(r => r.Id == group.Key).CalculatorRunOrganisationDataMasterId!.Value;

                    orgDataDetails.Add(new CalculatorRunOrganisationDataDetail
                    {
                        Id = orgDataDetails.Count + 1,
                        CalculatorRunOrganisationDataMasterId = masterId,
                        OrganisationId = producerDetail.ProducerId,
                        OrganisationName = $"TestOrgName|Master_{masterId}|Producer_{producerDetail.ProducerId}",
                    });
                }
            }

            return orgDataDetails;
        }

        public static CalculatorRunContext CalculatorRunContext =>
            new()
            {
                RunId = 1,
                RelativeYear = new RelativeYear(2025),
                RunName = "Test Run",
                ProcessingStartedAt = new DateTimeOffset(2026,1,1,0,0,0, TimeSpan.Zero),
                User = "Test User",
            };

        public static BillingRunContext BillingRunContext =>
            new()
            {
                RunId = 3,
                RelativeYear = new RelativeYear(2025),
