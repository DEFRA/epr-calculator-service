...
{
    /// <summary>
    ///     ⛔ Don't use with new tests. This is a static (shared) fixture for compatability with legacy test behaviour.
    /// </summary>
    ...
    public static IFixture New(Action<IFixtureOptions>? opts = null)
    {
        ...
        var client = new TestAppInsightsTelemetryClient();
        fixture.Inject(client);
        fixture.Inject<ITelemetryClient>(client);
    ...
    private static IFixture GetDefaultFixture()
    {
        ...
        fixture.Register(() => DummyData.GetCalcResult());
        fixture.Register(() => DummyData.RunContexts.CalculatorRun2026);
        fixture.Register(() => DummyData.RunContexts.BillingRun2026);
