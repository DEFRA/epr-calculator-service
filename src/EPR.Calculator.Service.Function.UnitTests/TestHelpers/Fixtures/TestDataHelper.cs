...
namespace EPR.Calculator.Service.Function.UnitTests.TestHelpers.Fixtures
{
    public static class TestDataHelper
    {
        ...
        public static List<CalcResultSummaryProducerDisposalFees> GetProducerDisposalFeesWithoutLevel1(bool showModulations = false)
        {
            var fees = GetProducerDisposalFees(showModulations);
        ...
        public static void SeedDatabaseForInitialRun(ApplicationDBContext context)
        {
            ...
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2025), Classification = RunClassification.InitialRunCompleted, CalculatorRunOrganisationDataMasterId = orgMasters[0].Id, Name = "CalculatorRunTest1" },
                new() { Id = 2, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, CalculatorRunOrganisationDataMasterId = orgMasters[1].Id, Name = "CalculatorRunTest2" }
            ];
        ...
        public static void SeedDatabaseForUnclassified(ApplicationDBContext context)
        {
            ...
            List<CalculatorRun> runs =
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, CalculatorRunOrganisationDataMasterId = orgMasters[0].Id, Name = "CalculatorRunTest1" },
                new() { Id = 2, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, CalculatorRunOrganisationDataMasterId = orgMasters[1].Id, Name = "CalculatorRunTest2" }
            ];
            context.CalculatorRuns.AddRange(runs);
        ...
        public static void SeedDatabaseForInitialRunCompleted(ApplicationDBContext context)
        {
            ...
            [
                new() { Id = 1, RelativeYear = new RelativeYear(2025), Classification = RunClassification.InitialRunCompleted, CalculatorRunOrganisationDataMasterId = orgMasters[0].Id, Name = "CalculatorRunTest1" },
                new() { Id = 2, RelativeYear = new RelativeYear(2025), Classification = RunClassification.InterimRecalculationRunCompleted, CalculatorRunOrganisationDataMasterId = orgMasters[1].Id, Name = "CalculatorRunTest2" },
                new() { Id = 3, RelativeYear = new RelativeYear(2025), Classification = RunClassification.Running, CalculatorRunOrganisationDataMasterId = orgMasters[2].Id, Name = "CalculatorRunTest3" }
            ];
            context.CalculatorRuns.AddRange(runs);
