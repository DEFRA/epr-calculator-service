...
public static class DbSeedData
{
    ...
    public static ImmutableList<CalculatorRunRelativeYear> RelativeYears =>
    [
        new() { Value = 2023 },
        new() { Value = 2024 },
        new() { Value = 2025 },
    ...
    public static ImmutableList<CalculatorRun> CalculatorRuns =>
    [
    ...
    public static ImmutableList<CalculatorRunOrganisationDataMaster> OrganisationMasters =>
    [
    ...
    public static ImmutableList<CalculatorRunPomDataMaster> PomMasters =>
    [
        new () { Id = 1, RelativeYear = new RelativeYear(2025), EffectiveFrom = Defaults.ValidForCalculatorRun.CreatedAt, CreatedAt = Defaults.ValidForCalculatorRun.CreatedAt, CreatedBy = "Test user" },
        new () { Id = 2, RelativeYear = new RelativeYear(2025), EffectiveFrom = Defaults.ValidForBillingRun.CreatedAt, CreatedAt = Defaults.ValidForBillingRun.CreatedAt, CreatedBy = "Test user" }
    ];

    public static ImmutableList<ProducerResultFileSuggestedBillingInstruction> SuggestedBillingInstruction =>
    [
    ...
    public static ImmutableList<Material> Materials =>
    [
