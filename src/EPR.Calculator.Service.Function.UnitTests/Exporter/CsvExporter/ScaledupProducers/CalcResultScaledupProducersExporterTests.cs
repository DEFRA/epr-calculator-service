    ...
    public class CalcResultScaledupProducersExporterTests
    {
        ...
        private IEnumerable<CalcResultScaledupProducerHeader> GetCoulmnHeaders()
        {
            return new List<CalcResultScaledupProducerHeader>
            {
                ...
                new CalcResultScaledupProducerHeader { Name = "Household Packaging Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Public Bin Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Household Drinks Containers Tonnage - Glass" },
                new CalcResultScaledupProducerHeader { Name = "Total Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Self Managed Consumer Waste Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Net Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Scaled-up Household Packaging Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Scaled-up Public Bin Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Scaled-up Household Drinks Containers Tonnage - Glass" },
                new CalcResultScaledupProducerHeader { Name = "Scaled-up Total Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Scaled-up Self Managed Consumer Waste Tonnage" },
                new CalcResultScaledupProducerHeader { Name = "Scaled-up Net Tonnage" },
            };
        }
