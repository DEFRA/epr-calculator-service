                ...
                [
                    new CalcResultSummaryProducerDisposalFees
                    {
                        ProducerCommsFeesByMaterial =
                            TestFixtures.Legacy.Create<Dictionary<string, CalcResultSummaryProducerCommsFeesCostByMaterial>>(),
                        ProducerDisposalFeesByMaterial =
                            TestFixtures.Legacy.Create<Dictionary<string, CalcResultSummaryProducerDisposalFeesByMaterial>>(),
                        ProducerId = "1",
                        ProducerName = "Test",
