...
namespace EPR.Calculator.Service.Function.UnitTests.Exporter.CsvExporter.Modulation
{
    ...
    public class CalcResultModulationExporterTests
    {
        ...
        public void Modulation_Export_CSV()
        {
            ...
            SelfManagedConsumerWasteData mkSmcwData(decimal red, decimal amber, decimal green, decimal? asmcw)
            {
                return new SelfManagedConsumerWasteData
                {
                    SelfManagedConsumerWasteTonnage = 0m,
                    ActionedSelfManagedConsumerWasteTonnage = asmcw,
            ...
            var smcw = new SelfManagedConsumerWaste
            {
                ...
                {
                    [al.Code] = mkSmcwData(red: 21000000.123m, amber: 5000000.234m, green: 209863.182m, asmcw: 123.456m),
                    [fc.Code] = mkSmcwData(red:     3001.333m, amber:  400000.222m, green:    706.332m, asmcw: null    )
                }
            };
