...
public class ProducerDisposalFeesWithBadDebtProvision1Tests
{
    ...
    public void From_MapsMaterialBreakdown()
    {
        ...
        Assert.AreEqual("£607.53", al.ProducerDisposalFeeWithoutBadDebtProvision);
    ...
    public void From_MapsMaterialBreakdown_Modulated()
    {
        ...
        Assert.AreEqual("£643.98", al.ProducerDisposalFeeWithBadDebtProvision);
        Assert.AreEqual("£607.53", al.ProducerDisposalFeeWithoutBadDebtProvision.Modulated!.Total);
