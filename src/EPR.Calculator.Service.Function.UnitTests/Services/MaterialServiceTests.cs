...
namespace EPR.Calculator.Service.Function.UnitTests.Services
{
    ...
    public class MaterialServiceTests
    {
        ...
        {
            var dbMaterials = TestData.Materials.Select(m => new Material
            {
                Id = m.Id,
                Code = m.Code,
                Name = m.Name
        ...
        public async Task Should_return_materials()
        {
            ...
            // Assert
            result.Length.ShouldBe(TestData.Materials.Length);
        }
        ...
        public async Task Should_return_materials_by_type()
        {
            ...
            // Assert
            result.Count.ShouldBe(TestData.Materials.Length);
        }
    }
}