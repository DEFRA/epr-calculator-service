...
namespace EPR.Calculator.Service.Function.UnitTests.Services
{
    ...
    public class ErrorReportServiceTests
    {
        ...
        public void Setup()
        {
            ...
            _service = new ErrorReportService(dbContext, new TestBulkOps(), mockProductDetails.Object, new Mock<ILogger<ErrorReportService>>().Object);
        }
        ...
        public async Task HandleErrors_AllTypes()
        {
            ...
            mockProductDetails
            .Setup(m => m.GetInvoicedProducerRecords(It.IsAny<RelativeYear>(), It.IsAny<ImmutableHashSet<int>>(), It.IsAny<CancellationToken>()))
