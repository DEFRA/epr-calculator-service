...
namespace EPR.Calculator.Service.Function.UnitTests.Services
{
    ...
    public class ProducerInvoiceNetTonnageServiceTests
    {
        ...
        public async Task CanCallCreateProducerInvoiceNetTonnage1()
        {
            ...
            _materialService.Setup(m => m.GetMaterials(It.IsAny<CancellationToken>())).ReturnsAsync(TestData.Materials);
        ...
        public async Task CanCallCreateProducerInvoiceTonnageWithNoProducers()
        {
            ...
            _materialService.Setup(mock => mock.GetMaterials(It.IsAny<CancellationToken>())).ReturnsAsync(TestFixtures.Default.Create<ImmutableArray<MaterialDto>>());
        ...
        public async Task CannotCallCreateProducerInvoiceTonnageWithNullCalcResult()
        {
            // Arrange
            var runContext = TestFixtures.Default.Create<CalculatorRunContext>();
            var calcResult = TestFixtures.Default.Create<CalcResult>();
