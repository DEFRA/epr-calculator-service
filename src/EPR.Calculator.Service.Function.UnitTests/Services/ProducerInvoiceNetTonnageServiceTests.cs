...
namespace EPR.Calculator.Service.Function.UnitTests.Services
{
    ...
    public class ProducerInvoiceNetTonnageServiceTests
    {
        ...
        public async Task CanCallCreateProducerInvoiceNetTonnage1()
        {
            ...
            _materialService.Setup(m => m.GetMaterials(It.IsAny<CancellationToken>())).ReturnsAsync(DummyData.Materials);
        ...
        public async Task CanCallCreateProducerInvoiceTonnageWithNoProducers()
        {
            ...
            _materialService.Setup(mock => mock.GetMaterials(It.IsAny<CancellationToken>())).ReturnsAsync(TestFixtures.Legacy.Create<ImmutableList<MaterialDetail>>());
