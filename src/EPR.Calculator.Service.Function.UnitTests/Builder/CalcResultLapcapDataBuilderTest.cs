...
namespace EPR.Calculator.Service.Function.UnitTests.Builder
{
    ...
    public class CalcResultLapcapDataBuilderTest
    {
        ...
        public async Task ConstructTest_For_Aluminuim_Plastic()
        {
            ...
            Assert.AreEqual(5, lapcapResults.CalcResultLapcapDataDetail.Count());

            var headerRow = lapcapResults.CalcResultLapcapDataDetail.Single(x => x.OrderId == 1);
            ...
            var aluminiumRow = lapcapResults.CalcResultLapcapDataDetail.Single(x => x.Name == aluminium);
            ...
            var plasticRow = lapcapResults.CalcResultLapcapDataDetail.Single(x => x.Name == plastic);
            ...
            var totalRow = lapcapResults.CalcResultLapcapDataDetail.Single(x => x.OrderId == 4);
            ...
            var countryApp = lapcapResults.CalcResultLapcapDataDetail.Single(x => x.OrderId == 5);
