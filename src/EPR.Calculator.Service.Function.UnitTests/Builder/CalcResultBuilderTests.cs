...
public class CalcResultBuilderTests : TestsFor<CalcResultBuilder>
{
    ...
    public async Task Build_ShouldReturnCalcResult_WithProjectedProducers()
    {
        ...
        mockCalcResultService.Verify(m => m.StoreProjectedH1Data(runContext.RunId, It.IsAny<IReadOnlyList<CalcResultH1ProjectedProducer>>(), CancellationToken.None), Times.Once);
        mockCalcResultService.Verify(m => m.StoreProjectedH2Data(runContext.RunId, It.IsAny<IReadOnlyList<CalcResultH2ProjectedProducer>>(), CancellationToken.None), Times.Once);
        ...
        mockCalcResultService.Verify(m => m.StoreProducerMaterialPackaging(It.IsAny<List<L1Producer>>(), CancellationToken.None), Times.Once);
    }
    ...
    public async Task Build_ShouldReturnCalcResult_WithProjectedProducers_Billing()
    {
        ...
        mockCalcResultService.Verify(m => m.StoreProducerMaterialPackaging(It.IsAny<List<L1Producer>>(), CancellationToken.None), Times.Never);
    }
    ...
    public async Task Build_ShouldReturnCalcResult_StoreDisposalFees_ResultFile()
    {
        ...
        mockCalcResultService.Verify(m => m.StoreProducerFees(runContext.RunId, result.ProducerFees, CancellationToken.None), Times.Once);
    }
    ...
    public async Task Build_ShouldReturnCalcResult_ReadDisposalFees_Billing()
    {
        ...
        mockCalcResultService.Setup(m => m.ReadPartialData(runContext.RunId, CancellationToken.None))
            .ReturnsAsync(mockCalcResultPartialData.Object);
        mockCalcResultService.Setup(m => m.ReadProducerFees(runContext.RunId, CancellationToken.None))
