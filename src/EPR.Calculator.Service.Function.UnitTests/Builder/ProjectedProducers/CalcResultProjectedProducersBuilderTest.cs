...
namespace EPR.Calculator.Service.Function.UnitTests.Builder.ProjectedProducers
{
    ...
    public class CalcResultProjectedProducersBuilderTest
    {
        ...
        public async Task H1H2Projection_untouched()
        {
            ...
            var expected = new [] {
                new[] { "101", "", "2025-H1", "1", "AL", "HH", "100", "30.0", "40.0", "40.0", "0", "0", "0" },
        ...
        public async Task H1H2Projection_subtotal_hg_no_parent_report_multi_materials()
        {
            ...
            var given = new[] {
                new[] { "101", "A", "2025-H1", "", "ST", "HH", "100", "30",  "40", "40",  "0",  "", "" },
                new[] { "101", "A", "2025-H2", "", "AL", "HH", "100", "30",  "40", "40",  "0",  "", "" },
                new[] { "101", "A", "2025-H1", "", "PL", "PB", "100", "30",  "40", "40",  "0",  "", "" },
                new[] { "101", "A", "2025-H2", "", "PL", "PB", "100", "30",  "40", "40",  "0",  "", "" },
                new[] { "101", "B", "2025-H1", "", "ST", "HH", "200", "50",  "50", "100", "0",  "", "" },
                new[] { "101", "B", "2025-H2", "", "AL", "HH", "200", "150", "25", "25",  "0",  "", "" }
            };
            var expected = new[]  {
                new[] { "101", "",  "2025-H1", "1", "PL", "PB", "100", "30.0", "40.0", "40.0", "0", "0", "0" },
                new[] { "101", "",  "2025-H1", "1", "ST", "HH", "300", "80",   "90",   "140",  "0", "0", "0" },
                new[] { "101", "A", "2025-H1", "2", "PL", "PB", "100", "30.0", "40.0", "40.0", "0", "0", "0" },
                new[] { "101", "A", "2025-H1", "2", "ST", "HH", "100", "30",   "40",   "40",   "0", "0", "0" },
                new[] { "101", "B", "2025-H1", "2", "ST", "HH", "200", "50",   "50",   "100",  "0", "0", "0" },

                new[] { "101", "",  "2025-H2", "1", "AL", "HH", "300", "180",  "65",   "65",   "0", "0", "0" },
                new[] { "101", "",  "2025-H2", "1", "PL", "PB", "100", "30",   "40",   "40",   "0", "0", "0" },
                new[] { "101", "A", "2025-H2", "2", "AL", "HH", "100", "30",   "40",   "40",   "0", "0", "0" },
                new[] { "101", "B", "2025-H2", "2", "AL", "HH", "200", "150",  "25",   "25",   "0", "0", "0" },
                new[] { "101", "A", "2025-H2", "2", "PL", "PB", "100", "30",   "40",   "40",   "0", "0", "0" }
            };
            AssertExcepted(expected, await FillGaps(given));
        }
