...
public class CalcResultSummaryBuilderTests
{
    ...
    private IMaterialService materialService = null!;
    ...
    public void Init()
    {
        ...
        fixture.Register<IMaterialService>(() => new MaterialService(context));
        materialService = fixture.Freeze<IMaterialService>();
        ...
        _sut = new CalcResultSummaryBuilder(context, materialService);
    }
    ...
    {
        // Assign
        calcResult.CalcResultScaledupProducers = TestData.GetScaledupProducers();
    ...
    {
        // Assign
        calcResult.CalcResultPartialObligations = TestData.GetPartialObligations();
    ...
    {
        // Act
        var result = _sut.GetPreviousInvoicedTonnageFromDb(new RelativeYear(2024));
    ...
    public async Task GetCalcResultSummary_ShouldReturnCorrectValue()
    {
        ...
        var producerInvoicedMaterialNetTonnage = _sut.GetPreviousInvoicedTonnageFromDb(new RelativeYear(2024));
        ...
        calcResult.CalcResultModulation = "add modulations section";
        var result2 = _sut.GetCalcResultSummary(orderedProducerDetails, materials, calcResult, totalPackagingTonnage, producerInvoicedMaterialNetTonnage, defaultParams);
    ...
    private static void SeedDatabase(ApplicationDBContext context)
    {
        ...
        {
            new() { Id = 1, CalculatorRunId = 1, ProducerId = 1, SuggestedBillingInstruction = "INITIAL", BillingInstructionAcceptReject = "Accepted" },
            new() { Id = 2, CalculatorRunId = 2, ProducerId = 2, SuggestedBillingInstruction = "INITIAL", BillingInstructionAcceptReject = "Accepted" },
            new() { Id = 3, CalculatorRunId = 3, ProducerId = 3, SuggestedBillingInstruction = "INITIAL", BillingInstructionAcceptReject = "Accepted" }
        });
