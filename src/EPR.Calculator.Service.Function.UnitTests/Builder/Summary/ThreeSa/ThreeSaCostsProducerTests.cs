...
namespace EPR.Calculator.Service.Function.UnitTests.Builder.Summary.ThreeSa
{
    ...
    public class ThreeSaCostsProducerTests
    {
        ...
        private Dictionary<MaterialDto, CalcResultSummaryProducerDisposalFeesByMaterial>? _materialCostSummary;
        private Dictionary<MaterialDto, CalcResultSummaryProducerCommsFeesCostByMaterial>? _commsCostSummary;
        ...
        public void TestInitialize()
        {
            ...
            [
                ...
                new MaterialDto { Id = 2, Code = "FC", Name = "Fibre composite" },
                new MaterialDto { Id = 3, Code = "GL", Name = "Glass" },
                new MaterialDto { Id = 4, Code = "PC", Name = "Paper or card" },
                new MaterialDto { Id = 5, Code = "PL", Name = "Plastic" },
                new MaterialDto { Id = 6, Code = "ST", Name = "Steel" },
                new MaterialDto { Id = 7, Code = "WD", Name = "Wood" },
                new MaterialDto { Id = 8, Code = "OT", Name = "Other materials" }
            ];
