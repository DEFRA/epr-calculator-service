...
namespace EPR.Calculator.Service.Function.UnitTests.Builder
{
    ...
    public class CalcResultParameterOtherCostBuilderTest
    {
        ...
        public void Init()
        {
            ...
            dbContext.DefaultParameterTemplateMasterList.AddRange(TestDataHelper.GetDefaultParameterTemplateMasterData());
        ...
        public async Task ConstructTest()
        {
            ...
            var otherCost = await builder.ConstructAsync(TestFixtures.Legacy.Create<CalculatorRunContext>());
