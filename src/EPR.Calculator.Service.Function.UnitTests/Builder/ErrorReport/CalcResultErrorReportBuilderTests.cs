...
public class CalcResultErrorReportBuilderTests
{
    ...
    private CalcResultErrorReportBuilder _sut = null!;
    ...
    public void Init()
    {
        ...
        _sut = _fixture.Freeze<CalcResultErrorReportBuilder>();
    }
    ...
    public async Task ConstructAsync_ReturnsMappedErrorReport()
    {
        ...
        _dbContext.CalculatorRunOrganisationDataMaster.AddRange(DummyData.GetCalculatorRunOrganisationDataMaster());
        _dbContext.CalculatorRunOrganisationDataDetails.AddRange(DummyData.GetCalculatorRunOrganisationDataDetails());
        _dbContext.CalculatorRuns.Add(runContext.ToEntity(run => run.CalculatorRunOrganisationDataMasterId = 1));

        _dbContext.ErrorReports.AddRange(
    ...
    public async Task ConstructAsync_NullSubsidiaryId_MapsToEmptyString()
    {
        ...
        _dbContext.ErrorReports.Add(new API.Data.DataModels.ErrorReport
        {
            Id = 1,
            CalculatorRunId = runContext.RunId,
            ProducerId = 1,
