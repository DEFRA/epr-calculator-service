...
namespace EPR.Calculator.Service.Function.UnitTests.Builder.ErrorReport
{
    ...
    public class CalcResultErrorReportBuilderTests
    {
        ...
        public async Task ConstructAsync_ReturnsMappedErrorReport()
        {
            ...
            dbContext.CalculatorRunOrganisationDataMaster.AddRange(TestDataHelper.GetCalculatorRunOrganisationDataMaster());
            dbContext.CalculatorRunOrganisationDataDetails.AddRange(TestDataHelper.GetCalculatorRunOrganisationDataDetails());
            dbContext.CalculatorRuns.AddRange(TestDataHelper.GetCaculatorRuns());
