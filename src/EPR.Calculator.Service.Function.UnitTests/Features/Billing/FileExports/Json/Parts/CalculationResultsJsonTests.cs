...
public class CalculationResultsJsonFromTests
{
    ...
    {
        // Arrange
        var runContext = DummyData.RunContexts.BillingRun2026;
        var data = DummyData.GetCalcResultSummary();
        var materials = DummyData.Materials;

        // Act
        var obj = CalculationResultsJson.From(runContext, data, materials);
