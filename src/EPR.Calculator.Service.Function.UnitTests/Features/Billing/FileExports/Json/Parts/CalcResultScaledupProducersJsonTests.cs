...
public class CalcResultScaledupProducersJsonTests
{
    ...
    public void From_ProducesProducerSubmissions()
    {
        ...
        var result = CalcResultScaledupProducersJson.From(runContext, scaled, TestDataHelper.Materials);
        ...
        var withRealAccepted = CalcResultScaledupProducersJson.From(acceptedReal, scaled, TestDataHelper.Materials);
