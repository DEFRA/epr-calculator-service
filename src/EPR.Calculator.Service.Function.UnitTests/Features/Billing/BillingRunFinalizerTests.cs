...
public class BillingRunFinalizerTests
{
    ...
    public async Task Should_commit_changes()
    {
        ...
        _calcResult.CalcResultSummary = TestDataHelper.GetCalcResultSummary();
    ...
    {
        // Arrange:
        _calcResult.CalcResultSummary.ProducerDisposalFees = TestDataHelper.GetProducerDisposalFeesWithoutLevel1();
