...
namespace EPR.Calculator.Service.Function.UnitTests.Converters;
...
public class CurrencyJsonConverterTests
{
    public CurrencyJsonConverterTests()
    {
        ...
        TestClass = new CurrencyJsonConverter();
    }

    private CurrencyJsonConverter TestClass { get; }
    ...
    {
        // Arrange
        var expectedValue = TestFixtures.Legacy.Create<decimal>();
    ...
    public void CanCallWrite()
    {
        ...
        var value = TestFixtures.Legacy.Create<decimal>();
