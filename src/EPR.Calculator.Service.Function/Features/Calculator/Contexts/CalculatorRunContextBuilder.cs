...
public interface ICalculatorRunContextBuilder
{
    ...
    /// </exception>
    Task<CalculatorRunContext> CreateContext(int runId, string? user, CancellationToken cancellationToken);
}
...
{
    public async Task<CalculatorRunContext> CreateContext(int runId, string? user, CancellationToken cancellationToken)
    {
