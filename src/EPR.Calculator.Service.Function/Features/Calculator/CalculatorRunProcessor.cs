    ...
    : ICalculatorRunProcessor
{
    public async Task<bool> Process(CalculatorRunContext runContext, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var calcResult = await telemetry.TrackDuration("CalculatorRun.Processor.ResultBuilder", () =>
            ...
            var exportResult = await telemetry.TrackDuration("CalculatorRun.Processor.FileExporter", () =>
