...
namespace EPR.Calculator.Service.Function.Features.Billing.FileExports.Json.Parts
{
    public class CalcResultLaDisposalCostDataJson
    {
        ...
        {
            static IEnumerable<CalcResultLaDisposalCostDetails> GetMaterialBreakdown(IEnumerable<CalcResultLaDisposalCostDataDetail> laDisposalCostDataDetail)
            {
                ...
                {
                    commsByMaterialDataDetails.Add(Parts.CalcResultLaDisposalCostDetails.From(item));
                }
