...
namespace EPR.Calculator.Service.Function.Features.Billing.FileExports.Json.Parts
{
    public record CalcResultScaledupProducersJson
    {
        ...
        public static CalcResultScaledupProducersJson From(BillingRunContext runContext, CalcResultScaledupProducers calcResultScaledupProducers, ImmutableList<MaterialDetail> materials)
        {
    ...
    public record ProducerSubmission
    {
        ...
        public static ProducerSubmission From(int? level, CalcResultScaledupProducer item, ImmutableList<MaterialDetail> materials)
        {
            static IEnumerable<MaterialBreakdown> GetMaterialBreakdown(Dictionary<string, CalcResultScaledupProducerTonnage> producerTonnageByMaterial, ImmutableList<MaterialDetail> materials)
            {
