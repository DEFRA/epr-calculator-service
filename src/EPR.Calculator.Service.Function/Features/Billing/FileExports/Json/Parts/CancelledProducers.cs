...
namespace EPR.Calculator.Service.Function.Features.Billing.FileExports.Json.Parts
{
    public record CancelledProducers
    {
        ...
        {
            static IEnumerable<CancelledProducerTonnageInvoice> GetCancelledProducerTonnageInvoice(CalcResultCancelledProducersResponse calcResultCancelledProducersResponse)
            {
                ...
                foreach (var producer in calcResultCancelledProducersResponse.CancelledProducers)
                {
                    ...
                    cancelledProducerTonnageInvoices.Add(Parts.CancelledProducerTonnageInvoice.From(runNumber, producer));
                }
