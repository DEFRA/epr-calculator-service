namespace EPR.Calculator.Service.Function.Constants
{
    public static class CommonConstants
    {
        ...
        public const string ModulatedProducerReportedTotalTonnage = "Producer Household Tonnage + Late Reporting Tonnage + Public Bin Tonnage + Household Drinks Containers Tonnage - Self Managed Consumer Waste";
