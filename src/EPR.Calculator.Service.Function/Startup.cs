...
internal static class ServiceRegistration
{
    ...
    private static void RegisterCommonDependencies(IServiceCollection services)
    {
        ...
        services.AddTransient<ICalcResultSummaryPartExporter, Section1DisposalFeeExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, Section2aMaterialsExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, Section2aCommsExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, Section1DisposalExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, Section2aComms2aExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, CommsCost2aPercentageExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, CommsCost2bExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, CommsCost2cExporter>();
        services.AddTransient<ICalcResultSummaryPartExporter, OnePlus2a2b2cExporter>();
        ...
        services.AddTransient<ICalcResultSummaryPartExporter, BillingInstructionsExporter>();
