...
public class CalculationResultsJson
{
    ...
    private static ProducerCalculationResultsSummary ArrangeSummary(CalcResultSummary data)
    {
        ...
        {
            FeeForLaDisposalCostsWithoutBadDebtprovision1 = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.LADisposalCostsSection1.FeeWithoutBadDebtProvision),
            BadDebtProvision1                             = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.LADisposalCostsSection1.BadDebtProvision),
            FeeForLaDisposalCostsWithBadDebtprovision1    = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.LADisposalCostsSection1.FeeWithBadDebtProvision.Total),

            FeeForCommsCostsByMaterialWithoutBadDebtprovision2a = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2a.FeeWithoutBadDebtProvision),
            BadDebtProvision2a                                  = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2a.BadDebtProvision),
            FeeForCommsCostsByMaterialWitBadDebtprovision2a     = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2a.FeeWithBadDebtProvision.Total),

            FeeForCommsCostsUkWideWithoutBadDebtprovision2b = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2b.FeeWithoutBadDebtProvision),
            BadDebtProvision2b                              = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2b.BadDebtProvision),
            FeeForCommsCostsUkWideWithBadDebtprovision2b    = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2b.FeeWithBadDebtProvision.Total),

            FeeForCommsCostsByCountryWithoutBadDebtprovision2c  = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.CommsCostsSection2c.FeeWithoutBadDebtProvision),
            ...
            SaOperatingCostsWithBadDebtProvision3    = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.SaOperatingCostsSection3.FeeWithBadDebtProvision.Total),

            LaDataPrepCostsWithoutBadDebtProvision4 = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.LaDataPrepSection4.FeeWithoutBadDebtProvision),
            BadDebtProvision4                       = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.LaDataPrepSection4.BadDebtProvision),
            LaDataPrepCostsWithbadDebtProvision4    = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.LaDataPrepSection4.FeeWithBadDebtProvision.Total),

            OneOffFeeSaSetupCostsWithoutBadDebtProvision5 = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.SaSetupCostsSection5.FeeWithoutBadDebtProvision),
            BadDebtProvision5                             = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.SaSetupCostsSection5.BadDebtProvision),
            OneOffFeeSaSetupCostsWithBadDebtProvision5    = CurrencyConverterUtils.ConvertToCurrency(data.OverallTotal.SaSetupCostsSection5.FeeWithBadDebtProvision.Total)
        };
    }
