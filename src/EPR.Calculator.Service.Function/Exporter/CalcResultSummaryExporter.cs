namespace EPR.Calculator.Service.Function.Exporter
{
    ...
    public class CalcResultSummaryExporter : ICalcResultSummaryExporter
    {
            ...
            CalcResultSummaryProducerDisposalFees producer)
        {
            ...
            {
                csvContent.Append(CsvSanitiser.SanitiseData(disposalFee.Value.PreviousInvoicedTonnage, null, null));
                ...
                csvContent.Append(CsvSanitiser.SanitiseData(disposalFee.Value.TonnageChange, null,null));
