...
public interface IBillingInstructionsExporter : ICalcResultSummaryPartExporter { }

public class BillingInstructionsExporter : IBillingInstructionsExporter
{
    ...
    public void AppendRow(StringBuilder csvContent, CalcResultSummaryProducerDisposalFees producer, bool applyModulation)
    {
        ...
        csvContent.Append(CsvSanitiser.SanitiseData(CurrencyConverterUtils.FormattedCurrencyValue(s.CurrentYearInvoiceTotalToDate), DecimalPlaces.Two, null, true));
        csvContent.Append(CsvSanitiser.SanitiseData(s.TonnageChangeSinceLastInvoice ?? CommonConstants.Hyphen));
        csvContent.Append(CsvSanitiser.SanitiseData(CurrencyConverterUtils.FormattedCurrencyValue(s.LiabilityDifference), DecimalPlaces.Two, null, true));
        ...
        csvContent.Append(CsvSanitiser.SanitiseData(CurrencyConverterUtils.FormattedCurrencyValue(s.SuggestedInvoiceAmount), DecimalPlaces.Two, null, true));
    }
}
