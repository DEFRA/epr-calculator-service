...
namespace EPR.Calculator.Service.Function.Models
{
    public class CalcResult
    {
        ...
        public CalcResultSummary CalcResultSummary { get; set; } = new() { CalculatorRunId = 0, OverallTotal = new() { ProducerId = 0, SubsidiaryId = string.Empty, ProducerName = string.Empty } };
