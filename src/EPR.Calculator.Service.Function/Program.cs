...
using Configuration = EPR.Calculator.Service.Function.Configuration;
...
static void ConfigureTelemetryServices(IServiceCollection services)
{
    services.AddApplicationInsightsTelemetryWorkerService();
    services.ConfigureFunctionsApplicationInsights();

    services.AddSingleton<ICalculatorTelemetryLogger, CalculatorTelemetryLogger>(provider =>
    {
        var fallbackToConsole = Environment.GetEnvironmentVariable("APPINSIGHTS_INSTRUMENTATIONKEY") ==
                                "00000000-0000-0000-0000-000000000000";

        return ActivatorUtilities.CreateInstance<CalculatorTelemetryLogger>(provider, fallbackToConsole);
    });
}

static void SetupDbContext(IServiceCollection services) =>
...
static void SetupBlobStorage(IServiceCollection services) =>
