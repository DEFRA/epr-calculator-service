                    ...
                    return new ProducerSelfManagedConsumerWaste
                    {
                        ...
                        SelfManagedConsumerWasteDataPerMaterials =
                            materialDetails.ToDictionary(
                                ...
                                material => {
                                    var smcw         = GetTonnage(producerDetail, material, PackagingTypes.ConsumerWaste, scaledUpProducers, partialObligations);
                                    var totalTonnage = GetReportedTonnage(producerDetail, material, scaledUpProducers, partialObligations);
