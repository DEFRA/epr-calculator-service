...
namespace EPR.Calculator.Service.Function.Services
{
    ...
    {
        Task StoreProjectedProducers(RunContext runContext, List<ProducerDetail> producerDetails);
    }
    ...
    {
        public async Task StoreProjectedProducers(RunContext runContext, List<ProducerDetail> producerDetails)
        {
