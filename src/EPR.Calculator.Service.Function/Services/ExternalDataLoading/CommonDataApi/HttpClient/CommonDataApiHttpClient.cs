...
namespace EPR.Calculator.Service.Function.Services.ExternalDataLoading.CommonDataApi.HttpClient;
...
public class CommonDataApiHttpClient
{
    ...
    public CommonDataApiHttpClient(System.Net.Http.HttpClient httpClient, IOptions<CommonDataApiHttpClientOptions> options)
    {
    ...
    {
        ArgumentNullException.ThrowIfNull(relativeYear);
