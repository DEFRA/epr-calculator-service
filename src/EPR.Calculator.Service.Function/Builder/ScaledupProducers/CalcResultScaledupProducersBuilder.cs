...
public interface ICalcResultScaledupProducersBuilder
{
    Task<(List<ProducerDetail>, CalcResultScaledupProducers)> ConstructAsync(
        ...
        ImmutableList<MaterialDetail> materialDetails,
        List<ProducerDetail> producerDetails
    );
}

public class CalcResultScaledupProducersBuilder(ApplicationDBContext dbContext)
    : ICalcResultScaledupProducersBuilder
{
    ...
    )
    {
        ...
        var scaledUpProducers = await GetScaledUpProducersAsync(runContext.RunId, organisationIds);
    ...
    public static List<CalcResultScaledupProducerHeader> GetColumnHeaders(IEnumerable<MaterialDetail> materials)
    {
        ...
        foreach (var material in materials)
        {
            ...
            {
                new() { Name = CalcResultScaledupProducerHeaders.HouseholdPackagingWasteTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.PublicBinTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.TotalTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.SelfManagedConsumerWasteTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.NetTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.ScaledupHouseholdPackagingWasteTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.ScaledupPublicBinTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.ScaledupTotalTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.ScaledupSelfManagedConsumerWasteTonnage },
                new() { Name = CalcResultScaledupProducerHeaders.ScaledupNetTonnage }
            };
