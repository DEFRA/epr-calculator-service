    ...
    public class CalcResultParameterOtherCostBuilder : ICalcResultParameterOtherCostBuilder
    {
        ...
        public async Task<CalcResultParameterOtherCost> ConstructAsync(CalcResultsRequestDto resultsRequestDto)
        {
            ...
            return new CalcResultParameterOtherCost
            {
                ...
                MaterialityIncrease   = new Materiality { Amount = tonIncrease.ParameterValue   , Percentage = tonPercentageIncrease.ParameterValue },
                MaterialityDecrease   = new Materiality { Amount = tonDecrease.ParameterValue   , Percentage = tonPercentageDecrease.ParameterValue },
                TonnageChangeIncrease = new Materiality { Amount = amountIncrease.ParameterValue, Percentage = percentageIncrease.ParameterValue },
                TonnageChangeDecrease = new Materiality { Amount = amountDecrease.ParameterValue, Percentage = percentageDecrease.ParameterValue },
            };
        }
