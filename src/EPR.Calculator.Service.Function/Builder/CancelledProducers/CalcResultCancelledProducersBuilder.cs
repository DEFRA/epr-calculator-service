...
{
    Task<CalcResultCancelledProducersResponse> ConstructAsync(CalcResultsRequestDto runContext, List<MaterialDetail> materialDetails);
}
...
{
    public async Task<CalcResultCancelledProducersResponse> ConstructAsync(CalcResultsRequestDto runContext, List<MaterialDetail> materialDetails)
    {
    ...
    private async Task<ImmutableList<CalcResultCancelledProducersDto>> GetCancelledProducers(CalcResultsRequestDto runContext, List<MaterialDetail> materialDetails)
    {
