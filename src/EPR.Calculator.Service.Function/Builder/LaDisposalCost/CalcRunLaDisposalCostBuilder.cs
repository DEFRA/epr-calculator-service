        ...
        )
        {
            ...
            var lapcapDetailsByMaterial =
                lapcapData.ByMaterial.Select(detail =>
                {
                    ...
                    var lateReportingTonnageValue = lateReportingTonnage.LateReportingTonnageByMaterial[materialCode].TotalLateReportingTonnage;
            ...
            var totalLateReportingTonnageValue = lateReportingTonnage.LateReportingTonnageTotal.TotalLateReportingTonnage;
            ...
            decimal? totalActionedSelfManagedConsumerWasteTonnage = applyModulation ? smcw.OverallTotalPerMaterials.Values.Sum(x => x.ActionedSelfManagedConsumerWasteTonnage ?? 0) : null;
            var total = new CalcResultLaDisposalCostDataDetail
                {
                    ...
                    ActionedSelfManagedConsumerWasteTonnage = applyModulation ? smcw.OverallTotalPerMaterials.Values.Sum(x => x.ActionedSelfManagedConsumerWasteTonnage ?? 0) : null,
