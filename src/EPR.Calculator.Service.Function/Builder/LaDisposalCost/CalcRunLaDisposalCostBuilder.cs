...
namespace EPR.Calculator.Service.Function.Builder.LaDisposalCost
{
    ...
    public class CalcRunLaDisposalCostBuilder : ICalcRunLaDisposalCostBuilder
    {
        ...
        )
        {
            ...
            var lapcapDetailsByMaterial =
                lapcapData.ByMaterial.Select(detail =>
                {
                    ...
                    decimal? actionedSelfManagedConsumerWasteTonnage = runContext.RequiresModulation ? smcw.OverallTotalByMaterial[materialCode].SMCW.ActionedSMCWTonnage.Total ?? 0 : null;
        ...
        {
            // TODO note returns duplicates for SubmissionPeriod - should remove it from ProducerMaterialPackaging - it's not needed
            ...
            return await (
                ...
                join producerMaterial in context.ProducerMaterialPackaging on producerDetail.Id equals producerMaterial.ProducerDetailId
