namespace EPR.Calculator.Service.Function.Builder.Summary.ThreeSa
{
    public static class ThreeSaCostHeader
    {
        ...
        public static readonly string TotalSaOperatingCostsWoTitleSection3 = "3 Total Producer Fee for SA Operating Costs In proportion to Percentage of Overall Producer Cost of (1+2a+2b+2c) w/o Bad Debt provision";
        public static readonly string BadDebtProvisionSection3 = "Bad Debt provision for 3";
        public static readonly string SaOperatingCostsWithTitleSection3 = "3 Total Producer Fee for SA Operating Costs In proportion to Percentage of Overall Producer Cost of (1+2a+2b+2c) with Bad Debt provision";
