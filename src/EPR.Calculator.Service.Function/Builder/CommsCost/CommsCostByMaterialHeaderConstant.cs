namespace EPR.Calculator.Service.Function.Builder.CommsCost
{
    public class CommsCostByMaterialHeaderConstant
    {
        ...
        public const string ProducerReportedHouseholdPlusLateReportingTonnage = "Producer Household Packaging Waste Tonnage + Late Reporting Tonnage + Public Bin Tonnage + Household Drinks Containers Tonnage";
