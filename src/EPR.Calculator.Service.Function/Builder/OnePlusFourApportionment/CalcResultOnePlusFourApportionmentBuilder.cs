...
public class CalcResultOnePlusFourApportionmentBuilder : ICalcResultOnePlusFourApportionmentBuilder
{
    public CalcResultOnePlusFourApportionment Construct(CalcResultLapcapData lapcapData, CalcResultParameterOtherCost otherCost)
    {
        ...
        var totalLACost = GetTotalCost(lapcapData, totalLabel);
        ...
        var dataPrepCharge = otherCost.Details
    ...
    private static CalcResultLapcapDataDetail GetTotalCost(CalcResultLapcapData lapcapData, string name)
    {
        return lapcapData.CalcResultLapcapDataDetails
