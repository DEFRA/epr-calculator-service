...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20241024125526_OrganisationIDToInt")]
    partial class OrganisationIDToInt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 24, 13, 55, 26, 589, DateTimeKind.Local).AddTicks(5014),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 24, 13, 55, 26, 589, DateTimeKind.Local).AddTicks(5017),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 24, 13, 55, 26, 589, DateTimeKind.Local).AddTicks(5019),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 24, 13, 55, 26, 589, DateTimeKind.Local).AddTicks(5022),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 10, 24, 13, 55, 26, 589, DateTimeKind.Local).AddTicks(5024),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
