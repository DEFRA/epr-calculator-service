...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20241018110438_OrganisationAndPomChanges")]
    partial class OrganisationAndPomChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 18, 12, 4, 37, 821, DateTimeKind.Local).AddTicks(2280),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 18, 12, 4, 37, 821, DateTimeKind.Local).AddTicks(2289),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 18, 12, 4, 37, 821, DateTimeKind.Local).AddTicks(2296),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 18, 12, 4, 37, 821, DateTimeKind.Local).AddTicks(2302),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 10, 18, 12, 4, 37, 821, DateTimeKind.Local).AddTicks(2308),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
