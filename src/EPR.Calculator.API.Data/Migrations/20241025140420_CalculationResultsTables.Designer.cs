...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20241025140420_CalculationResultsTables")]
    partial class CalculationResultsTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 25, 15, 4, 19, 929, DateTimeKind.Local).AddTicks(1118),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 25, 15, 4, 19, 929, DateTimeKind.Local).AddTicks(1125),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 25, 15, 4, 19, 929, DateTimeKind.Local).AddTicks(1130),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 25, 15, 4, 19, 929, DateTimeKind.Local).AddTicks(1135),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 10, 25, 15, 4, 19, 929, DateTimeKind.Local).AddTicks(1140),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
