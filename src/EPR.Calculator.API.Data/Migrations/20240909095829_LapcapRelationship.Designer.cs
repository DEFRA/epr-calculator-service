...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20240909095829_LapcapRelationship")]
    partial class LapcapRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 9, 10, 58, 28, 730, DateTimeKind.Local).AddTicks(9507),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 9, 10, 58, 28, 730, DateTimeKind.Local).AddTicks(9513),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 9, 10, 58, 28, 730, DateTimeKind.Local).AddTicks(9519),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 9, 10, 58, 28, 730, DateTimeKind.Local).AddTicks(9523),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 9, 10, 58, 28, 730, DateTimeKind.Local).AddTicks(9528),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
