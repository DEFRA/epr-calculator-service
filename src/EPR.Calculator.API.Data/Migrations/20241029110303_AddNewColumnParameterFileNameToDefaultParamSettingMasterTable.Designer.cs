            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 29, 11, 3, 2, 850, DateTimeKind.Local).AddTicks(7790),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 29, 11, 3, 2, 850, DateTimeKind.Local).AddTicks(7797),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 29, 11, 3, 2, 850, DateTimeKind.Local).AddTicks(7802),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 29, 11, 3, 2, 850, DateTimeKind.Local).AddTicks(7808),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 10, 29, 11, 3, 2, 850, DateTimeKind.Local).AddTicks(7813),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
